...
public sealed class RefreshTokenCommandHandlerTests
{
    ...
    public async Task Handle_WhenRefreshTokenIsValid_RotatesTokenAndReturnsNewTokens()
    {
        ...
        refreshTokens.Setup(x => x.UpdateAsync(storedToken, It.IsAny<CancellationToken>())).Returns(ValueTask.CompletedTask);
        refreshTokens.Setup(x => x.SaveChangesAsync(It.IsAny<CancellationToken>())).Returns(Task.CompletedTask);
        ...
        refreshTokens.Verify(x => x.UpdateAsync(storedToken, It.IsAny<CancellationToken>()), Times.Once);
